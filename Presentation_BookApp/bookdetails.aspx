...
<body>
    ...
    <table>
        <tr><td>Book Name * : </td><td class="auto-style1">
        ...
        <tr><td>Author * : </td><td class="auto-style1">
        ...
        <tr><td>Publisher * : </td><td class="auto-style1">
        ...
        <tr><td>Price * : </td><td class="auto-style1">
        ...
        <br />   
    <asp:GridView ID="grdBookDetails" runat="server" DataKeyNames="BookName"
